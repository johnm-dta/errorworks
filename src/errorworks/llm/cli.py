...
def _version_callback(value: bool) -> None:
    ...
    if value:
        ...
        try:
            typer.echo(f"chaosllm (errorworks {version('errorworks')})")
...
def serve(
    ...
    workers: Annotated[
        ...
        typer.Option(
            "--workers",
            "-w",
            help="Number of uvicorn workers (default: from preset or 1).",
            min=1,
        ),
    ] = None,
    # Metrics database
...
def mcp_main(
    ...
    try:
        ...
        from errorworks.llm_mcp.server import run_server
